...
TEMPLATE_MAIN_ADMIN = """
>`cFDG-Kommunikator Feature-Request`c
{msg}
`cHier finden Sie alle gewünschten Features. Sollten Sie ein neues Feature wünschen oder eine Idee zu einer Verbesserung haben können Sie diese hier einstellen. Prüfen Sie bitte ob nicht schon ein Eintrag existiert.

Hierfür können Sie die Suche des Browsers verwenden. (Obere Toolbar)

Ansonsten klicken Sie auf `[Feature hinzufügen`:`page=add]`" um ein neuer Wunsch zu äußern.
...
>`cFDG-Kommunikator Feature-Request`c
{msg}
>>>`cNeues Feature/Idee hinzufügen:
...
MSG_ADD_OK = "\n>>>`cStatus: `F080Erfolgreich hinzugefügt!`f\n\nVielen Dank für Ihre Untersützung bei der Verbesserung des FDG-Kommunikators!`c\n"
